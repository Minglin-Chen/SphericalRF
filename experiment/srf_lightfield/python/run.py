...
def parse_args():
	...
	parser.add_argument("--predict_width", type=int, default=400, help="The width of image of prediction")
	parser.add_argument("--predict_height", type=int, default=200, help="The height of image of prediction")
	parser.add_argument("--predict_angle_x", type=float, default=49, help="The field-of-view of prediction in x-axis (unit:degree)")
...
if __name__ == "__main__":
	...
	if args.load_snapshot:
		...
		# load dataset
		testbed.load_training_data(args.scene, 0.5, [0.5,0.5,0.5], args.discard_saturation, 'lightfield')
