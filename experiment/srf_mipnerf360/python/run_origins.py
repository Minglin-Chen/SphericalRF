...
def one_trial(args, translation=[0.5,0.5,0.5]):
	testbed = ngp.Testbed()
	...
	if args.load_snapshot:
		...
		# load dataset
		testbed.load_training_data(args.scene, 0.5, translation, args.discard_saturation, 'mipnerf360')
...
if __name__ == "__main__":
	...
	filename = osp.basename(args.save_snapshot)
	scenename = osp.basename(osp.dirname(args.save_snapshot))
	outputdir = osp.dirname(osp.dirname(args.save_snapshot))

	# translation = [0.5, 0.5, 0.5]
	# args.save_snapshot = osp.join(
	# 	outputdir, scenename, f"{translation[0]:.2f}_{translation[1]:.2f}_{translation[2]:.2f}", filename)
	# one_trial(args, translation)

	# translation = [0.5-0.25, 0.5, 0.5]
	# args.save_snapshot = osp.join(
	# 	outputdir, scenename, f"{translation[0]:.2f}_{translation[1]:.2f}_{translation[2]:.2f}", filename)
	# one_trial(args, translation)

	# translation = [0.5, 0.5-0.25, 0.5]
	# args.save_snapshot = osp.join(
	# 	outputdir, scenename, f"{translation[0]:.2f}_{translation[1]:.2f}_{translation[2]:.2f}", filename)
	# one_trial(args, translation)

	# translation = [0.5, 0.5, 0.5-0.25]
	# args.save_snapshot = osp.join(
	# 	outputdir, scenename, f"{translation[0]:.2f}_{translation[1]:.2f}_{translation[2]:.2f}", filename)
	# one_trial(args, translation)
	...
	translation = [0.5-1.0, 0.5, 0.5]
	args.save_snapshot = osp.join(
		outputdir, scenename, f"{translation[0]:.2f}_{translation[1]:.2f}_{translation[2]:.2f}", filename)
	one_trial(args, translation)

	translation = [0.5, 0.5-1.0, 0.5]
	args.save_snapshot = osp.join(
		outputdir, scenename, f"{translation[0]:.2f}_{translation[1]:.2f}_{translation[2]:.2f}", filename)
	one_trial(args, translation)
